...
case 1073741915:
asDSSP = true;
version = (this.slen == e.iToken + 1 ? 2 : Clazz_floatToInt (this.floatParameter (++e.iToken)));
break;
case 0:
...
var bsAtoms = this.vwr.setModelkitProperty ("assignBond",  Clazz_newIntArray (-1, [bondIndex, (type).charCodeAt (0)]));
